                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <h2 class="text-bold-700">{{ Auth::user()->favourite_posts()->count() }}</h2>
                                <p class="mb-0 line-ellipsis">Favourite Post</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <h2 class="text-bold-700">{{$total_authors}}</h2>
                                <p class="mb-0 line-ellipsis">total_authors</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <h2 class="text-bold-700">{{$total_authors_today}}</h2>
                                <p class="mb-0 line-ellipsis">today Join</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <h2 class="text-bold-700">{{$categories}}</h2>
                                <p class="mb-0 line-ellipsis">Total Categories</p>
                            </div>
                        </div>
                    </div>
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <h2 class="text-bold-700">{{$tags}}</h2>
                                <p class="mb-0 line-ellipsis">Total Tags</p>
                            </div>
                        </div>
                    </div>
                </div>
