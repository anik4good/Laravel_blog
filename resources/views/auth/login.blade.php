...
@push('css')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/backend')}}/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
@endpush
                    ...
                    <div class="card bg-authentication rounded-0 mb-0">
                        <div class="row m-0">
                            <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                <img src="{{asset('public/assets/backend')}}/app-assets/images/pages/login.png" alt="branding logo">
                            </div>
                                                ...
                                                <div class="form-group d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="text-right">
                                                        @if (Route::has('password.request'))
                                                            <a href="{{ route('password.request') }}" class="card-link">Forgot Password?</a>@endif
                                                    </div>
                                                </div>
